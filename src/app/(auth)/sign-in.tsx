...
import { friendlyAuthError, signInWithEmail, signUpWithEmail } from '@/features/auth/actions';
...
const styles = StyleSheet.create({
  flex: { flex: 1 },
  header: { alignItems: 'center', gap: spacing.sm, paddingTop: spacing.xxl, paddingBottom: spacing.xl },
